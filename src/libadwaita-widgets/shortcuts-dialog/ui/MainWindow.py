...
class ExampleWindow(Adw.ApplicationWindow):
    ...
    adw_shortcuts_dialog = Gtk.Template.Child(name='adw_shortcuts_dialog')
    ...
    def on_open_button_open_shortcuts_clicked(self, widget):
        self.adw_shortcuts_dialog.set_size_request(width=683, height=384)
        self.adw_shortcuts_dialog.present()
