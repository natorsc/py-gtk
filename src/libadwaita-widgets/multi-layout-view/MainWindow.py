...
class ExampleWindow(Adw.ApplicationWindow):
    def __init__(self, **kwargs):
        ...
        adw_bottom_sheet.set_content(content=Adw.LayoutSlot.new(id="slot-content"))
        ...
        adw_status_page.set_description(description="Adw.Layout - Adw.LayoutSlot")
        adw_toolbar_view.set_content(content=adw_status_page)
        # Adding slot in Adw.MultiLayoutView.
        adw_multi_layout_view.set_child(id="slot-content", child=adw_toolbar_view)
