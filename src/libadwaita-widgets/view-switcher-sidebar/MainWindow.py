...
class ExampleWindow(Adw.ApplicationWindow):
    def __init__(self, **kwargs):
        ...
        self.adw_navigation_split_view.set_sidebar(sidebar=adw_navigation_page_sidebar)
        ...
        self.adw_navigation_split_view.set_content(content=adw_navigation_page_content)
