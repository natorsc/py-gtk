...
class ExampleWindow(Gtk.ApplicationWindow):
    def __init__(self, **kwargs):
        ...
        self.create_win_action(name="item1", callback=self.on_menu_item_clicked)
        self.create_win_action(name="item2", callback=self.on_menu_item_clicked)
        ...
        self.create_win_action(name="item3", callback=self.on_menu_item_clicked)
        self.create_win_action(name="item4", callback=self.on_menu_item_clicked)
